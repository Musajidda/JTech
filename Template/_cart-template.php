                    ...
                    <form action="" class="form py-3">
                       ...
                       <div class="form-group w-75 m-auto pb-3">
                        ...
                        <select name="" id="" class="form-control w-75 m-auto">
                            ...
                            <option value="">E-Naira</option>
                            <option value="">Bitcoin</option>
                        </select>
                       
                    </form>
                    <div class="border-top py-4">
                        <h5 class="font-baloo font-size-20">Total ( <?php echo isset($subTotal) ? count($subTotal) : 0; ?> item):&nbsp; <span class="text-danger">₦<span class="text-danger" id="deal-price"><?php echo isset($subTotal) ? $Cart->getSum($subTotal) : 0; ?></span> </span> </h5>
